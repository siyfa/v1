      ...
      <div className="max-w-screen-xl flex flex-wrap flex-col mx-auto pt-24 md:px-28 px-5">
        ...
        <div className="flex flex-wrap flex-col justify-between mt-10 mb-10 ">
          <div className="flex flex-wrap md:flex-row relative">
            ...
            <div className="md:w-1/3 w-full  md:relative absolute top-0">
              ...
              <div className="md:bg-[#080808] bg-[rgba(10,10,10,0.9)] md:h-56 h-[50vh] w-full absolute md:top-20 top-0 md:right-1/4 ">
              ...
              <ul className="flex flex-wrap text-sm absolute md:bottom-12 bottom-[-400px] left-2 md:left-5 space-x-4">
                <li>React</li>
                <li>Node</li>
                <li>Express</li>
                <li>Express</li>
              </ul>
              <ul className="flex flex-wrap text-sm absolute md:bottom-0 bottom-[-450px] left-2 md:left-5 space-x-4">
